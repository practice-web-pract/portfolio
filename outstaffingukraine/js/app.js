(() => {
    ...
    function initSliders() {
        if (document.querySelector(".feedbacks__slider")) new core(".feedbacks__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".feedbacks__pagination.swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".feedbacks__arrow-left.swiper-button-prev",
                nextEl: ".feedbacks__arrow-right.swiper-button-next"
            },
            breakpoints: {
                300: {
                    slidesPerView: 1,
